...
var bgOverlayColor1 = '#FFF6BA';
var bgOverlayColor2 = '#E84B06';
var bgOverlayOpacity = '0.8'; // Set 0 if you do't need to overlay color
...
var launchDate = "10/01/2015 12:00:00"; //  your date MM/DD/YYYY HH:MM:SS 
var offset = "+10"; 
/* ==============================================
END PAGE SETINGS
=============================================== */
...
/*Background*/
if (bgOverlayColor1 == "" || bgOverlayColor1 == undefined) bgOverlayColor1 = '#348F50';
if (bgOverlayColor2 == "" || bgOverlayColor2 == undefined) bgOverlayColor2 = '#56B4D3';

if ($(".bg-overlay").length) {
    $(".bg-overlay").css('background-color', bgOverlayColor1)
                    .css("background", "-webkit-linear-gradient(180deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 60%)")
                    .css("background", "-moz-linear-gradient(180deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 60%)")
                    .css("background", "-ms-linear-gradient(180deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 60%)")
                    .css("background", "-o-linear-gradient(180deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 60%)")
                    .css("background", "linear-gradient(180deg, " + "rgba(" + hexToRgb(bgOverlayColor1).r + "," + hexToRgb(bgOverlayColor1).g + "," + hexToRgb(bgOverlayColor1).b + "," + bgOverlayOpacity + ")" + " 10%, " + "rgba(" + hexToRgb(bgOverlayColor2).r + "," + hexToRgb(bgOverlayColor2).g + "," + hexToRgb(bgOverlayColor2).b + "," + bgOverlayOpacity + ")" + " 60%)");
}
