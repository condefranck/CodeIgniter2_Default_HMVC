...
function initialize() {
"use strict";
var myLatLng = new google.maps.LatLng(5.3162104,-4.0159496);
...
var mapOptions = {
  ...
  var contentString = '<div style="max-width: 300px" id="content">'+
      '<div id="bodyContent">'+
	  '<h4>CICG</h4>' +
      '<p style="font-size: 12px">Rue du commerce, Résidence du Front Lagunaire,<br />Façade lagunaire, 1er Etage , esc A. Plateau, Abidjan.</p>'+
      '</div>'+
      '</div>';
